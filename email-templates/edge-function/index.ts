// ══════════════════════════════════════════════════════════════════
//  Grillhashpowermine — Welcome Email Edge Function
...
<head>
  ...
  <title>Welcome to Grillhashpowermine</title>
</head>
        ...
        <tr>
          <td style="background:linear-gradient(160deg,#040a0f 0%,#071218 100%);padding:36px 40px 28px;">
            ...
            <p style="margin:0;font-size:16px;color:rgba(255,255,255,0.5);line-height:1.6;">
              Your Grillhashpowermine account has been successfully created.
            </p>
        ...
        <tr>
          <td style="padding:32px 40px;">
            ...
            <p style="margin:0;font-size:13px;color:rgba(255,255,255,0.35);line-height:1.7;text-align:center;">
              ...
              <a href="mailto:support@grillhashpowermine.com" style="color:#00e5ff;text-decoration:none;">
              ...
              <tr>
                <td>
                  <p style="margin:0;font-size:12px;color:rgba(255,255,255,0.2);">
                    Best regards,<br/>
                    <strong style="color:rgba(255,255,255,0.35);">The Grillhashpowermine Team</strong>
                  </p>
                </td>
                <td style="text-align:right;">
                  <p style="margin:0;font-size:11px;color:rgba(255,255,255,0.15);">
                    &copy; 2026 Grillhashpowermine.<br/>All rights reserved.
                  </p>
                </td>
              </tr>
              <tr>
...
serve(async (req: Request) => {
  try {
    ...
    const FROM_EMAIL = Deno.env.get("FROM_EMAIL") ?? "support@grillhashpowermine.com";
    const SITE_URL = Deno.env.get("SITE_URL") ?? "https://grillhashpowermine.com";
    ...
    const response = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: `Grillhashpowermine <${FROM_EMAIL}>`,
        to: [email],
        subject: `Welcome to Grillhashpowermine, ${firstName}! 🎉`,
        html,
      }),
    });
